...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-sm px-2.5 py-1 text-xs font-medium text-muted-foreground transition-colors',
      ...
      'data-[state=active]:bg-surface-3 data-[state=active]:text-foreground [&_svg]:size-3.5',
      className,
    )}
    {...props}
  />
